...
DESCRIPTION="Kernel sources used on the GCsVentures infrastructure. Contains the hardened gentoo patchset for the ${KV_MAJOR}.${KV_MINOR} kernel tree and ZFS 0.6.4.1"
