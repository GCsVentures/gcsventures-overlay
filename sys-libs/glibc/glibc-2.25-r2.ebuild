...
src_prepare() {
	...
	# Revert the deprecated sysmacros.h include as it breaks packages which haven't been updated yet.
	epatch --reverse "${FILESDIR}"/00_all_0005-sys-types.h-drop-sys-sysmacros.h-include.patch
}
